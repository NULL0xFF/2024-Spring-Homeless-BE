...
public class UserController {
  ...
  @Operation(summary = "Delete", description = "Delete user information")
  @SecurityRequirement(name = "bearerAuth")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "204", description = "Delete user information successful", content = @Content),
      @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content)})
  public ResponseEntity<Void> delete(HttpServletRequest servlet,
